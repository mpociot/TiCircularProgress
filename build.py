...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','de.marcelpociot.circularprogress.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','DeMarcelpociotCircularprogressModuleAssets.m')
